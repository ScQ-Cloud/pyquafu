...
def spin_adapted_t1(i, j):
    ...
    Examples:
        >>> from quafu.algorithm.nisq.chem.uccsd0 import spin_adapted_t1
        >>> spin_adapted_t1(2, 3)
        [1.0 [4^ 6] +
        1.0 [5^ 7] ]
        >>> spin_adapted_t1(1, 1)
...
def spin_adapted_t2(creation_list, annihilation_list):
    ...
    Examples:
        >>> from quafu.algorithm.nisq.chem.uccsd0 import spin_adapted_t2
...
def uccsd0_singlet_generator(
    ...
    Examples:
        >>> from quafu.algorithm.nisq import uccsd0_singlet_generator
