...
from quafu.core.gates import RX, RY, RZ, FSim, X
...
class RYLinear(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import RYLinear
...
class RYFull(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import RYFull
...
class RYRZFull(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import RYRZFull
...
class RYCascade(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import RYCascade
...
class ASWAP(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import ASWAP
...
class PCHeaXYZ1F(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import PCHeaXYZ1F
...
class PCHeaXYZ2F(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import PCHeaXYZ2F
