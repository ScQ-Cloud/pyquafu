...
from quafu.algorithm.nisq._ansatz import (
    Ansatz,
    Initializer,
    single_qubit_gate_layer,
)
from quafu.core.circuit import UN
from quafu.core.gates import BARRIER, RX, RY, RZ, H, X, Z
...
class Ansatz1(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz1
        >>> Ansatz1(3, 2).circuit
              ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━┓
...
class Ansatz2(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz2
        >>> Ansatz2(3, 2).circuit
              ┏━━━━━━━━┓ ┏━━━━━━━━┓       ┏━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━┓        ┏━━━┓
        q0: ──┨ RX(p0) ┠─┨ RZ(p3) ┠───────┨╺╋╸┠─┨ RX(p6) ┠─┨ RZ(p9) ┠────────┨╺╋╸┠───
              ┗━━━━━━━━┛ ┗━━━━━━━━┛       ┗━┳━┛ ┗━━━━━━━━┛ ┗━━━━━━━━┛        ┗━┳━┛
...
class Ansatz4(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz4
        >>> Ansatz4(3, 1).circuit
              ┏━━━━━━━━┓ ┏━━━━━━━━┓            ┏━━━━━━━━┓
...
class Ansatz7(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz7
        >>> Ansatz7(4, 1).circuit
              ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━━┓ ┏━━━━━━━━━┓
...
class Ansatz8(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz8
        >>> Ansatz8(4, 1).circuit
              ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━┓ ┏━━━━━━━━━┓ ┏━━━━━━━━━┓
...
class Ansatz9(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz9
        >>> Ansatz9(4, 2).circuit
              ┏━━━┓             ┏━━━┓ ┏━━━━━━━━┓ ┏━━━┓             ┏━━━┓ ┏━━━━━━━━┓
...
class Ansatz10(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz10
...
class Ansatz11(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz11
...
class Ansatz12(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz12
...
class Ansatz13(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz13
...
class Ansatz14(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz14
...
class Ansatz15(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz15
...
class Ansatz16(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz16
...
class Ansatz17(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz17
...
class Ansatz18(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz18
...
class Ansatz19(Ansatz, Initializer):
    ...
    Examples:
        >>> from quafu.algorithm.nisq import Ansatz19
