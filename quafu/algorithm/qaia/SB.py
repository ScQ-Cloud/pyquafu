...
from quafu.utils.type_value_check import _check_number_type, _check_value_should_not_less, _check_int_type
from .QAIA import QAIA, OverflowException

try:
    from quafu import _qaia_sb
...
class ASB(SB):  # noqa: N801
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.algorithm.qaia import ASB
        >>> J = np.array([[0, -1], [-1, 0]])
...
class BSB(SB):  # noqa: N801
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.algorithm.qaia import BSB
        >>> J = np.array([[0, -1], [-1, 0]])
...
class DSB(SB):  # noqa: N801
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.algorithm.qaia import DSB
        >>> J = np.array([[0, -1], [-1, 0]])
