...
def rxx_decompose(gate: gates.Rxx):
    ...
    Examples:
        >>> from quafu.algorithm.compiler import rxx_decompose
        >>> from quafu.core.circuit import Circuit
        >>> from quafu.core.gates import Rxx
        >>> rxx = Rxx(1).on([0, 1])
...
def crxx_decompose(gate: gates.Rxx):
    ...
    Examples:
        >>> from quafu.algorithm.compiler.decompose import crxx_decompose
        >>> from quafu.core import Circuit, Rxx
