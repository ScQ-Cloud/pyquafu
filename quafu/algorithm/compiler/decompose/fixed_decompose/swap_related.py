...
from quafu.utils.type_value_check import _check_control_num, _check_input_type
...
def swap_decompose(gate: gates.SWAPGate):
    ...
    Examples:
        >>> from quafu.algorithm.compiler.decompose import swap_decompose
        >>> from quafu.core.circuit import Circuit
        >>> from quafu.core.gates import SWAP
        >>> swap = SWAP.on([1, 0])
...
def cswap_decompose(gate: gates.SWAPGate):
    ...
    Examples:
        >>> from quafu.algorithm.compiler.decompose import cswap_decompose
        >>> from quafu.core import Circuit, SWAP
        >>> cswap = SWAP.on([1, 2], 0)
