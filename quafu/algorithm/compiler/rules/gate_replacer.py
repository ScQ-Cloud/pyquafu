...
# ============================================================================
"""Convert cnot to cz."""
from quafu.core.circuit import Circuit, apply
from quafu.core.gates import CNOT, BasicGate, X, Z
...
class GateReplacer(BasicCompilerRule):
    ...
    Examples:
        >>> from quafu.algorithm.compiler import GateReplacer, compile_circuit
