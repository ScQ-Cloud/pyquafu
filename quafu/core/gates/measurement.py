...
from quafu.utils.string_utils import join_without_empty
from quafu.utils.type_value_check import _check_input_type, _check_int_type
...
class MeasureResult:
    ...
    def __repr__(self):
        ...
        from quafu.io.display import measure_text_drawer
        from quafu.io.display._config import _MEA_RES_STYLE
    ...
    def _repr_html_(self):
        ...
        # pylint: disable=import-outside-toplevel,cyclic-import
        from quafu.io.display import measure_text_drawer
        from quafu.io.display._config import _MEA_RES_STYLE, MEA_HTML_FORMAT
    ...
    def svg(self, style=None):
        ...
        """
        # pylint: disable=import-outside-toplevel,cyclic-import
        from quafu.io.display._config import _svg_measure_config_official
        from quafu.io.display.measure_res_svg_drawer import SVGMeasure
