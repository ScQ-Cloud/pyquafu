...
from quafu.utils.f import pauli_string_matrix
from quafu.utils.quantifiers import s_quantifier
...
class NonHermitianGate(QuantumGate):
    ...
    def __type_specific_str__(self):
        """Return a string representation of the object."""
        # pylint: disable=import-outside-toplevel,cyclic-import
        from quafu.io.display._config import _DAGGER_MASK
