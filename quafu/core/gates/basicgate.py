...
from quafu import _math
from quafu import quafubackend as mb
from quafu.config.config import _GLOBAL_MAT_VALUE
from quafu.utils.f import is_power_of_two
from quafu.utils.type_value_check import _check_gate_type, _check_input_type, _check_numba_validation
...
class GroupedPauli(NoneParameterGate, SelfHermitianGate):
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.core.gates import GroupedPauli
...
class RotPauliString(ParameterOppsGate):
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.core.gates import RotPauliString
        >>> from quafu.core.operators import TimeEvolution, QubitOperator
        >>> from quafu.core.circuit import Circuit
    ...
    def __decompose__(self):
        """Gate decomposition method."""
        # pylint: disable=import-outside-toplevel
        from quafu.core.circuit import Circuit, controlled
...
class Power(NoneParamNonHermMat):
    ...
    Examples:
        >>> from quafu.core.gates import Power
        >>> import numpy as np
        >>> rx1 = RX(0.5)
        >>> rx2 = RX(1)
...
def gene_univ_parameterized_gate(name, matrix_generator, diff_matrix_generator):
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.core.circuit import Circuit
        >>> from quafu.core.gates import gene_univ_parameterized_gate
...
def gene_univ_two_params_gate(name, matrix_generator, diff_matrix_generator_1, diff_matrix_generator_2):
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.core.gates import gene_univ_two_params_gate
        >>> from quafu.core.circuit import Circuit
        >>> def matrix(a, b):
...
class Rn(MultiParamsGate):
    ...
    Examples:
        ...
        >>> from quafu.core.gates import Rn
...
class U3(MultiParamsGate):
    ...
    Examples:
        >>> from quafu.core.gates import U3
...
class FSim(MultiParamsGate):
    ...
    Examples:
        >>> from quafu.core.gates import FSim
