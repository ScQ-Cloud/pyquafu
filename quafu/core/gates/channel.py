...
from quafu.utils.f import _check_input_type, _check_num_array
from quafu.utils.string_utils import string_expression
...
class GroupedPauliChannel(NoiseGate, SelfHermitianGate):
    ...
    Examples:
        >>> import numpy as np
        >>> from quafu.core.gates import GroupedPauliChannel
        ...
        q1: ──┤─╢ PC(px=0, py=3/10, pz=0) ╟───├─┤ M q1 ├───
              ╰ ╚═════════════════════════╝   ╯ ┕━━━━━━┙
        >>> Simulator('quafuvector', circ.n_qubits).sampling(circ, shots=1000, seed=42)
        shots: 1000
...
class PauliChannel(NoiseGate, SelfHermitianGate):
    ...
    Examples:
        >>> from quafu.core.gates import PauliChannel
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit()
...
class BitFlipChannel(PauliChannel):
    ...
    Examples:
        >>> from quafu.core.gates import BitFlipChannel
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit()
...
class PhaseFlipChannel(PauliChannel):
    ...
    Examples:
        >>> from quafu.core.gates import PhaseFlipChannel
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit()
...
class BitPhaseFlipChannel(PauliChannel):
    ...
    Examples:
        >>> from quafu.core.gates import BitPhaseFlipChannel
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit()
...
class PhaseDampingChannel(NoiseGate, NonHermitianGate):
    ...
    Examples:
        >>> from quafu.core.gates import PhaseDampingChannel
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit()
...
class KrausChannel(NoiseGate, NonHermitianGate):
    ...
    Examples:
        >>> from quafu.core.gates import KrausChannel
        >>> from quafu.core.circuit import Circuit
...
class ThermalRelaxationChannel(NoiseGate, NonHermitianGate):
    ...
    Examples:
        >>> from quafu.core.gates import ThermalRelaxationChannel
        >>> from quafu.core.circuit import Circuit
        >>> t1 = 100000
        >>> t2 = 50000
        >>> gate_time = 35
