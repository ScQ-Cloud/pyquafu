...
import quafu
from quafu._math.ops import QubitOperator as QubitOperator_
...
class QubitOperator(QubitOperator_):
    ...
    def from_openfermion(of_ops) -> "QubitOperator":
        """
        Convert qubit operator from openfermion to quafu format.

        Args:
            of_ops (openfermion.QubitOperator): Qubit operator from openfermion.

        Returns:
            QubitOperator, qubit operator from quafu.
        """
