...
class ReverseAdder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import ReverseAdder, MeasureAccepter, BitFlipAdder, MixerAdder
...
class MeasureAccepter(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import MeasureAccepter, BitFlipAdder, MixerAdder
        >>> from quafu.core.circuit import Circuit
...
class NoiseExcluder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import Circuit, NoiseExcluder, BitFlipAdder, MixerAdder
        >>> from quafu.core.gates import DepolarizingChannel
        >>> circ = Circuit().x(0)
...
class BitFlipAdder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import BitFlipAdder
        >>> from quafu.core.circuit import Circuit
...
class NoiseChannelAdder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import NoiseChannelAdder, Circuit
        >>> from quafu.core.gates import AmplitudeDampingChannel
        >>> circ = Circuit().h(0).x(1, 0)
...
class DepolarizingChannelAdder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import MixerAdder, DepolarizingChannelAdder, GateSelector
        >>> from quafu.core.circuit import Circuit
        >>> circ = Circuit().h(0).x(1, 0)
...
class QubitNumberConstrain(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import QubitNumberConstrain, Circuit, BitFlipAdder, MixerAdder
        >>> circ = Circuit().h(0).x(1, 0)
        >>> circ
              ┏━━━┓
        q0: ──┨ H ┠───■─────
...
class QubitIDConstrain(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import MixerAdder, BitFlipAdder, QubitIDConstrain, Circuit
...
class SequentialAdder(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import SequentialAdder, MixerAdder, BitFlipAdder, NoiseChannelAdder
        >>> from quafu.core.circuit import MeasureAccepter, ReverseAdder, NoiseChannelAdder, Circuit
        >>> from quafu.core.circuit import NoiseExcluder
        >>> from quafu.core.gates import DepolarizingChannel
...
class GateSelector(ChannelAdderBase):
    ...
    Examples:
        >>> from quafu.core.circuit import BitFlipAdder, GateSelector, Circuit, MixerAdder
        >>> circ = Circuit().h(0).x(1, 0)
        >>> circ
              ┏━━━┓
        q0: ──┨ H ┠───■─────
