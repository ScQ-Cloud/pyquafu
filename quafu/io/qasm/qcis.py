...
class QCIS:
    ...
    def __init__(self):
        from quafu.core import gates as G  # pylint: disable=import-outside-toplevel,cyclic-import
        from quafu.core.circuit import Circuit  # pylint: disable=import-outside-toplevel,cyclic-import
