...
def random_hiqasm(n_qubits, gate_num, version='0.1', seed=42):  # pylint: disable=too-many-branches,too-many-statements
    ...
    Examples:
        >>> from quafu.io import random_hiqasm
        >>> from quafu.io import HiQASM
...
class HiQASM:
    ...
    def __init__(self):
        ...
        from quafu import Circuit  # pylint: disable=import-outside-toplevel
    ...
    def to_string(self, circuit, version='0.1'):  # pylint: disable=too-many-branches
        ...
        """
        from quafu import (  # pylint: disable=import-outside-toplevel
            Circuit,
            gates,
        )
