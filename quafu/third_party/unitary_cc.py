...
def uccsd_singlet_get_packed_amplitudes(single_amplitudes, double_amplitudes, n_qubits, n_electrons):
    ...
    from quafu.core.operators.utils import down_index, up_index
...
def uccsd_singlet_generator(n_qubits, n_electrons, anti_hermitian=True):
    ...
    Examples:
        >>> from quafu.algorithm.nisq.chem import uccsd_singlet_generator
    ...
    """
    # pylint: disable=import-outside-toplevel
    from quafu.core.operators import (  # pylint: disable=import-outside-toplevel
        FermionOperator,
    )
    from quafu.core.operators.utils import down_index, up_index
