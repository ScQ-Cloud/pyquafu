...
from ..quafubackend.device import QubitNode as QubitNode_
from ..quafubackend.device import QubitsTopology as QubitsTopology_
...
class QubitNode:
    ...
    Examples:
        >>> from quafu.device import QubitNode
        >>> q0 = QubitNode(0)
        >>> q1 = QubitNode(1)
        >>> q = q0 << q1
    ...
    def __gt__(self, other: "QubitNode") -> "QubitNode":
        ...
        Examples:
            >>> from quafu.device import QubitNode
            >>> from quafu.device import QubitsTopology
            >>> q0 = QubitNode(0)
            >>> q1 = QubitNode(1)
...
class QubitsTopology:
    ...
    def add_qubit_node(self, qubit: QubitNode) -> None:
        ...
        Examples:
            >>> from quafu.device import QubitsTopology, QubitNode
    ...
    def compress(self) -> typing.Tuple["QubitsTopology", typing.Dict[int, int]]:
        ...
        Examples:
            >>> from quafu.device import LinearQubits
    ...
    def edges_with_poi(self) -> typing.Set[typing.Tuple[typing.Tuple[float, float], typing.Tuple[float, float]]]:
        ...
        Examples:
            >>> from quafu.device import QubitNode, QubitsTopology
    ...
    def show(self, method: Optional[AVA_SHOW_METHOD] = None):
        ...
        from quafu.io.display import draw_topology, draw_topology_plt
...
class GridQubits(QubitsTopology):
    ...
    Examples:
        >>> from quafu.device import GridQubits
