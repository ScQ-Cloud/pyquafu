...
from quafu.core.circuit.channel_adder import ChannelAdderBase
from quafu.core.gates import BasicGate
...
class NoiseBackend(NoiseBackendImpl):
    ...
    Args:
        base_sim (str): The simulator that supported by quafu.
        ...
        dtype (quafu.dtype): The data type of simulator. If ``None``, it will be quafu.complex128.
            Default: ``None``.

    Examples:
        >>> from quafu.simulator import NoiseBackend, Simulator
        >>> from quafu.core.circuit import Circuit, MeasureAccepter, MixerAdder, BitFlipAdder
        ...
        q1: ────────┨╺╋╸┠─╢ BFC(p=1/5) ╟─┤ M q1 ├───
                    ┗━━━┛ ╚════════════╝ ┕━━━━━━┙
        >>> noise_sim = Simulator(NoiseBackend('quafuvector', 2, adder=adder))
