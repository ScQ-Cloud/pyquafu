...
from .quafu_blas import QUAFUBlas
from .quafusim import QUAFUSim


def get_supported_simulator():
    """
    Get simulator name that supported by quafu.
...
class Simulator:
    ...
    Args:
        ...
        dtype (quafu.dtype): the data type of simulator. Default: ``None``.
    ...
    def apply_circuit(self, circuit, pr=None):
        ...
        Examples:
            ...
            >>> sim
            quafuvector simulator with 2 qubits  (little endian).
    ...
    def apply_gate(self, gate, pr=None, diff=False):
        ...
        Examples:
            >>> import numpy as np
            >>> from quafu.core.gates import RY, Measure
            >>> from quafu.simulator import Simulator
    ...
    def apply_hamiltonian(self, hamiltonian: Hamiltonian):
        ...
        Examples:
            >>> from quafu.core.circuit import Circuit
            >>> from quafu.core.operators import QubitOperator, Hamiltonian
            >>> from quafu.simulator import Simulator
    ...
    def astype(self, dtype, seed=None):
        ...
        Args:
            dtype (quafu.dtype): the data type of new simulator.
    ...
    def copy(self):
        ...
        Examples:
            ...
            >>> sim2
            quafuvector simulator with 1 qubit (little endian).
            Current quantum state:
            1¦0⟩
        """
    ...
    def get_expectation_with_grad(
        ...
        Args:
            ...
            pr_shift (bool): Whether or not to use parameter-shift rule. Only available in "quafuvector" simulator.
        ...
        """
        if self.backend.name == "quafumatrix":
    ...
    def sampling(self, circuit, pr=None, shots=1, seed=None):
        ...
        Examples:
            >>> from quafu.core.circuit import Circuit
            >>> from quafu.core.gates import Measure
            >>> from quafu.simulator import Simulator
...
def inner_product(bra_simulator: Simulator, ket_simulator: Simulator):
    ...
    Examples:
        ...
        >>> from quafu.simulator import inner_product, Simulator
        >>> bra_simulator = Simulator('quafuvector', 1)
        >>> bra_simulator.apply_gate(RY(1.2).on(0))
        >>> ket_simulator = Simulator('quafuvector', 1)
    ...
    if isinstance(bra_simulator.backend, QUAFUSim):
        return QUAFUBlas.inner_product(bra_simulator.backend, ket_simulator.backend)
