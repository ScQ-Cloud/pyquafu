...
from quafu._math import dtype as dtype_
from quafu.utils.type_value_check import _check_quafu_type
...
quafu_number_type = [float32, float64, complex64, complex128]
quafu_real_number_type = [float32, float64]
quafu_complex_number_type = [complex64, complex128]
...
def to_quafu_type(dtype):
    """
    Convert type to quafu type.

    Args:
        dtype (Union[quafu.dtype, mindspore.dtype, numpy.dtype]): The data type supported by
            quafu or mindspore or numpy.

    Examples:
        >>> from quafu import to_quafu_type
        >>> import numpy as np
        >>> to_quafu_type(np.complex128)
        quafu.complex128
    """
    type_mapper = {
        float32: float32,
...
def to_real_type(dtype):
    ...
    Args:
        dtype (quafu.dtype): The data type supported by quafu.

    Examples:
        >>> from quafu import to_real_type, complex128
...
def to_complex_type(dtype):
    ...
    Examples:
        >>> from quafu import to_complex_type, float32
...
def to_double_precision(dtype):
    ...
    Examples:
        >>> from quafu import to_double_precision, float32
...
def to_single_precision(dtype):
    ...
    Examples:
        >>> from quafu import to_single_precision, complex128
...
def to_precision_like(dtype_src, dtype_des):
    ...
    Args:
        dtype_src (quafu.dtype): The data type supported by quafu.
        dtype_des (quafu.dtype): The data type supported by quafu.

    Examples:
        >>> from quafu import to_precision_like, float32, complex128
...
def to_np_type(dtype):
    ...
    Examples:
        >>> from quafu import to_np_type, complex128
...
def is_double_precision(dtype) -> bool:
    ...
    Examples:
        >>> from quafu import is_double_precision, complex128
...
def is_single_precision(dtype) -> bool:
    ...
    Examples:
        >>> from quafu import is_single_precision, complex128
...
def is_same_precision(dtype1, dtype2) -> bool:
    ...
    Args:
        dtype1 (quafu.dtype): The data type supported by quafu.
        dtype2 (quafu.dtype): The data type supported by quafu.

    Examples:
        >>> from quafu import is_same_precision, complex128, float64
...
def precision_str(dtype) -> str:
    ...
    Examples:
        >>> from quafu import precision_str, complex128
