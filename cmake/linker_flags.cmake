...
if(ENABLE_CUDA AND _nvcxx_enabled)
  ...
  foreach(_src_target nvhpc_cuda_flags_NVCXX nvhpc_cuda_version_flags_NVCXX)
    ...
    foreach(_dst_target ${_src_target} NVCXX_quafu NVCXX_try_compile NVCXX_try_compile_flagcheck)
  ...
  foreach(_dst_target nvhpc_gpu_compute_capability_NVCXX NVCXX_quafu)
    target_link_options(${_dst_target} INTERFACE ${_flag})
  endforeach()
...
if("${OS_NAME}" STREQUAL "MSYS-CLANG64")
  ...
  foreach(_lang C CXX DPCXX)
    if(TARGET ${_lang}_quafu)
      target_link_libraries(${_lang}_quafu INTERFACE "$<$<LINK_LANGUAGE:${_lang}>:${_ssp_library}>")
    endif()
  endforeach()
endif()
