...
PYBIND11_MODULE(_quafu_vector, module) {
    using namespace pybind11::literals;  // NOLINT
    std::string sim_name = "quafuvector";
#ifdef __CUDACC__
    using float_policy_t = quafu::sim::vector::detail::GPUVectorPolicyFloat;
    using double_policy_t = quafu::sim::vector::detail::GPUVectorPolicyDouble;
    sim_name = "quafuvector_gpu";
#elif defined(__x86_64__)
    using float_policy_t = quafu::sim::vector::detail::CPUVectorPolicyAvxFloat;
    using double_policy_t = quafu::sim::vector::detail::CPUVectorPolicyAvxDouble;
#elif defined(__amd64)
    using float_policy_t = quafu::sim::vector::detail::CPUVectorPolicyArmFloat;
    using double_policy_t = quafu::sim::vector::detail::CPUVectorPolicyArmDouble;
#endif  // __CUDACC__

    using float_vec_sim = quafu::sim::vector::detail::VectorState<float_policy_t>;
    using double_vec_sim = quafu::sim::vector::detail::VectorState<double_policy_t>;

    module.doc() = "quafu c++ vector state simulator.";
    ...
    BindSim<float_vec_sim>(float_sim, sim_name)
        .def("complex128", &float_vec_sim::astype<double_policy_t, quafu::sim::vector::detail::CastTo>)
        .def("complex64", &float_vec_sim::astype<float_policy_t, quafu::sim::vector::detail::CastTo>)
        .def("sim_name", [](const float_vec_sim& sim) {
#ifdef __CUDACC__
            return "quafuvector_gpu";
#else
            return "quafuvector";
#endif
        });
    ...
    BindSim<double_vec_sim>(double_sim, sim_name)
        .def("complex128", &double_vec_sim::astype<double_policy_t, quafu::sim::vector::detail::CastTo>)
        .def("complex64", &double_vec_sim::astype<float_policy_t, quafu::sim::vector::detail::CastTo>)
    ...
    pybind11::module float_blas = float_sim.def_submodule("blas", "quafu simulator algebra module.");
    pybind11::module double_blas = double_sim.def_submodule("blas", "quafu simulator algebra module.");
    ...
    pybind11::module stabilizer = module.def_submodule("stabilizer", "quafu stabilizer simulator.");
#ifndef __CUDACC__
    using namespace quafu::stabilizer;  // NOLINT
