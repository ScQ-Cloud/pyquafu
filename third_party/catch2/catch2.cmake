...
if(MSVC)
  ...
  if(ENABLE_ITERATOR_DEBUG)
    set(Catch2_CFLAGS "/D_ITERATOR_DEBUG_LEVEL=${QUAFU_ITERATOR_DEBUG}")
    set(Catch2_CXXFLAGS "${Catch2_CXXFLAGS} /D_ITERATOR_DEBUG_LEVEL=${QUAFU_ITERATOR_DEBUG}")
  endif()
...
quafu_add_pkg(
  ...
  TARGET_ALIAS quafu::catch2 Catch2::Catch2
  TARGET_ALIAS quafu::catch2_main Catch2::Catch2WithMain
