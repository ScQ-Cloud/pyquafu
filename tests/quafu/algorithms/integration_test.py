...
class TestQAOA:
    ...
    def test_run(self):
        ...
        hamiltonian_multi = Hamiltonian.from_pauli_list([("XYZIX", 1),
                                                         ("XYIZX", 1),
                                                         ("XIYZX", 1),
                                                         ("IXYZX", 1)])
        ...
        hamiltonian = Hamiltonian.from_pauli_list([("IIIZZ", 1), ("IIZIZ", 1),
                                                   ("IZIIZ", 1), ("ZIIIZ", 1)])
...
class TestVQE:
    ...
    def test_run(self):
        ...
        num_layers = 4
        num_qubits = 2
        hamlitonian = Hamiltonian.from_pauli_list([("YZ", 0.3980),
                                                   ("ZI", -0.3980),
                                                   ("ZZ", -0.0113),
                                                   ("XX", 0.1810)])
