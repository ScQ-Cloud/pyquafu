...
class CXGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int):
        super().__init__("X", [ctrl], [targ], None, matrix=XMatrix)
        self.symbol = "+"
...
class CYGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int):
        super().__init__("Y", [ctrl], [targ], None, matrix=YMatrix)
...
class CZGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int):
        super().__init__("Z", [ctrl], [targ], None, matrix=ZMatrix)
...
class CSGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int):
        super().__init__("S", [ctrl], [targ], None, matrix=SMatrix)
...
class CTGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int):
        super().__init__("T", [ctrl], [targ], None, matrix=TMatrix)
...
class CPGate(ControlledGate):
    ...
    def __init__(self, ctrl: int, targ: int, paras):
        super().__init__("P", [ctrl], [targ], paras, matrix=pmatrix(paras))
