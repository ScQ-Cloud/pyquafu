...
template <size_t word_size>
inline bool operator==(const bit_word<word_size>& left, const bit_word<word_size>& right) {
...
template <size_t word_size>
inline bit_word<word_size> operator<<(const bit_word<word_size>& word, int offset) {
...
template <size_t word_size>
inline bit_word<word_size> operator<<(const bit_word<word_size>& word, uint64_t offset) {
...
template <size_t word_size>
inline bit_word<word_size> operator<<=(bit_word<word_size>& word, uint64_t offset) {
...
template <size_t word_size>
inline bit_word<word_size> operator&(const bit_word<word_size>& word, uint64_t mask) {
...
template <size_t word_size>
inline bit_word<word_size> operator&(const bit_word<word_size>& word, int64_t mask) {
    return word & bit_word<word_size>(mask);
}
...
template <size_t word_size>
inline bit_word<word_size> operator&(const bit_word<word_size>& word, int mask) {
    return word & bit_word<word_size>(mask);
}
...
struct bit_word<64> {
    ...
    inline uint16_t count() const {
        return count_uint64_bits(u64[0]);
    }
    ...
    static void inplace_transpose_square(bit_word<64>* block_start, size_t stride) {
        inplace_transpose_64_step<0x5555555555555555ull, 1>((uint64_t*) block_start, stride);
        inplace_transpose_64_step<0x3333333333333333ull, 2>((uint64_t*) block_start, stride);
        inplace_transpose_64_step<0x0F0F0F0F0F0F0F0Full, 4>((uint64_t*) block_start, stride);
        inplace_transpose_64_step<0x00FF00FF00FF00FFull, 8>((uint64_t*) block_start, stride);
        inplace_transpose_64_step<0x0000FFFF0000FFFFull, 16>((uint64_t*) block_start, stride);
        inplace_transpose_64_step<0x00000000FFFFFFFFull, 32>((uint64_t*) block_start, stride);
    }
};
...
struct bit_word<256> {
    ...
    inline bit_word<256>(int64_t v) : m256{_mm256_set_epi64x(-(v < 0), -(v < 0), -(v < 0), v)} {
    }
    inline bit_word<256>(int v) : m256{_mm256_set_epi64x(-(v < 0), -(v < 0), -(v < 0), v)} {
    }
    ...
    inline uint16_t count() const {
        return count_uint64_bits(u64[0]) + count_uint64_bits(u64[1]) + count_uint64_bits(u64[2])
               + count_uint64_bits(u64[3]);
    }
    ...
    static void inplace_transpose_256_step(__m256i mask, __m256i* data, size_t stride) {
    ...
    static void inplace_transpose_64_and_128_step(bit_word<256>* data, size_t stride) {
        uint64_t* u64_ptr = (uint64_t*) data;
        stride <<= 2;
        for (std::size_t k = 0; k < 64; k++) {
            std::swap(u64_ptr[stride * (k + 64 * 0) + 1], u64_ptr[stride * (k + 64 * 1) + 0]);
            std::swap(u64_ptr[stride * (k + 64 * 0) + 2], u64_ptr[stride * (k + 64 * 2) + 0]);
            std::swap(u64_ptr[stride * (k + 64 * 0) + 3], u64_ptr[stride * (k + 64 * 3) + 0]);
            std::swap(u64_ptr[stride * (k + 64 * 1) + 2], u64_ptr[stride * (k + 64 * 2) + 1]);
            std::swap(u64_ptr[stride * (k + 64 * 1) + 3], u64_ptr[stride * (k + 64 * 3) + 1]);
            std::swap(u64_ptr[stride * (k + 64 * 2) + 3], u64_ptr[stride * (k + 64 * 3) + 2]);
        }
    }

    static void inplace_transpose_square(bit_word<256>* data, size_t stride) {
        inplace_transpose_256_step<1>(_mm256_set1_epi8(0x55), (__m256i*) data, stride);
        inplace_transpose_256_step<2>(_mm256_set1_epi8(0x33), (__m256i*) data, stride);
        inplace_transpose_256_step<4>(_mm256_set1_epi8(0x0F), (__m256i*) data, stride);
        inplace_transpose_256_step<8>(_mm256_set1_epi16(0x00FF), (__m256i*) data, stride);
        inplace_transpose_256_step<16>(_mm256_set1_epi32(0x0000FFFF), (__m256i*) data, stride);
        inplace_transpose_256_step<32>(_mm256_set1_epi64x(0x00000000FFFFFFFFull), (__m256i*) data, stride);
    }
};
#endif
