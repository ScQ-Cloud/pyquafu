...
struct circuit_instruction {
    ...
    circuit_instruction(std::string gate, span_ref<const size_t> targets, span_ref<const double> args = {})
...
inline std::ostream& operator<<(std::ostream& os, const circuit_instruction& instr) {
    os << instr.gate << " "
       << "targets: ";
...
struct quantum_circuit {
    ...
    quantum_circuit(const std::string& gate, const std::vector<size_t>& targets, const std::vector<double>& args = {})
    ...
    quantum_circuit& operator+=(const quantum_circuit& other) {
        ...
        if (&other == this) {
            instr_list.insert(instr_list.end(), other_instrs.begin(), other_instrs.end());
            return *this;
        }
    ...
    quantum_circuit& append(const std::string& gate, const std::vector<size_t>& targets,
    ...
    quantum_circuit& _append(const std::string& gate, span_ref<const size_t> targets, span_ref<const double> args) {
