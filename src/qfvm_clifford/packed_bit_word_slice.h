...
struct packed_bit_word_slice {
    ...
    packed_bit_word_slice(bit_word<word_size>* bw, size_t num_bit_words) : num_bit_words(num_bit_words), bw(bw) {
    }

    // assignment operator
    packed_bit_word_slice<word_size>& operator=(const packed_bit_word_slice<word_size>& other) {
    ...
    bool operator==(const packed_bit_word_slice<word_size>& other) const {
        return num_bit_words == other.num_bit_words && 0 == memcmp(bw, other.bw, num_bit_words * word_size / 8);
    }
    ...
    inline const bit operator[](size_t index) const {
        return bit(u8, index);
    }
    ...
    inline void for_each_word(func f) const {
        auto* bw_start = bw;
    ...
    template <typename func>
    inline void for_each_word(packed_bit_word_slice<word_size> other, func f) const {
        auto* bw_start = bw;
        auto* bw_end = bw + num_bit_words;
    ...
    template <typename func>
    inline void for_each_word(packed_bit_word_slice<word_size> other1, packed_bit_word_slice<word_size> other2,
                              func f) const {
        auto* bw_start = bw;
        auto* bw_end = bw + num_bit_words;
    ...
    template <typename func>
    inline void for_each_word(packed_bit_word_slice<word_size> other1, packed_bit_word_slice<word_size> other2,
                              packed_bit_word_slice<word_size> other3, func f) const {
        auto* bw_start = bw;
        auto* bw_end = bw + num_bit_words;
        auto* other1_bw_start = other1.bw;
        auto* other2_bw_start = other2.bw;
    ...
    template <typename func>
    inline void for_each_word(packed_bit_word_slice<word_size> other1, packed_bit_word_slice<word_size> other2,
                              packed_bit_word_slice<word_size> other3, packed_bit_word_slice<word_size> other4,
                              func f) const {
        auto* bw_start = bw;
        auto* bw_end = bw + num_bit_words;
        auto* other1_bw_start = other1.bw;
        ...
        while (bw_start != bw_end) {
            f(*bw_start, *other1_bw_start, *other2_bw_start, *other3_bw_start, *other4_bw_start);
            ++bw_start;
            ++other1_bw_start;
            ++other2_bw_start;
            ++other3_bw_start;
...
template <size_t word_size>
std::ostream& operator<<(std::ostream& os, const packed_bit_word_slice<word_size>& word) {
