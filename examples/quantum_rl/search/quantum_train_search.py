...
def main(bit_string,
    ...
    optimizer_var = tf.keras.optimizers.Adam(learning_rate=lr_var,
                                             amsgrad=True)
    optimizer_out = tf.keras.optimizers.Adam(learning_rate=lr_out,
                                             amsgrad=True)
    ...
    for batch in range(n_episodes // batch_size):
        # Gather episodes
        _, episodes = gather_episodes(state_bounds, n_actions, model,
                                      batch_size, env_name, beta, backend)
