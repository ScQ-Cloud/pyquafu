    ...
    for epoch in range(20):
        ...
        for epi in range(100):
            ...
            newtheta, newlamda = get_model_circuit_params(
                qubits, genotype, model)
            circuit, _, _ = generate_circuit(qubits, genotype, newtheta,
                                             newlamda, stateb)
            _, expectation = get_quafu_exp(circuit, args.n_qubits,
                                           args.backend_quafu, args.shots)
        ...
        frames[1].save('./visualization/gif/test_{}.gif'.format(epoch),
                       save_all=True,
